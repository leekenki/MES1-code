    ...
    public partial class MM_STockMM_M : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("14MM_STockMM_S1", CommandType.StoredProcedure
        ...
        private void ultraButton1_Click(object sender, EventArgs e)
        {
            ...
            DataRow drRow = ((DataTable)this.grid1.DataSource).NewRow(); //새로운 행을 넣는다.
            drRow["ITEMCODE"] = Convert.ToString(this.grid1.ActiveRow.Cells["ITEMCODE"].Value); //값을가져온다. 그리드랑 같은 명칭이어야한다.
            ...
            //미리보기 창 활성화
            ReportViewer reportViewer = new ReportViewer(repBook, 1); //만든 레포트북을 한장만 미리보기로 만든다.
