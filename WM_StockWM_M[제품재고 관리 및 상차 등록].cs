...
namespace KFQS_Form
{
    public partial class WM_StockWM_M : DC00_WinForm.BaseMDIChildForm
    {
        #region [ 생성자 ]
        ...
        #region [ Form Load ]
        private void WM_StockWM_M_Load(object sender, EventArgs e)
        {
            #region ▶ GRID ◀
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "SHIPFLAG",  "상차 여부",  true, GridColDataType_emu.VarChar,  100, 120, Infragistics.Win.HAlign.Left,  true, false);
        ...
        public override void DoInquire()
        {
            ...
            {   
                ...
                rtnDtTemp = helper.FillTable("14WM_StockWM_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            #region 수정 
                            helper.ExecuteNoneQuery("14WM_StockWM_U1", CommandType.StoredProcedure
