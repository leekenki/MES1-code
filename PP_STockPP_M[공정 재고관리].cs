    ...
    public partial class PP_STockPP_M : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("14PP_STockPP_S1", CommandType.StoredProcedure
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++ )
                {
                    ...
                    helper.ExecuteNoneQuery("14PP_STockPP_U1"
        ...
        private void ultraButton1_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(this.grid1.ActiveRow.Cells["ITEMTYPE"].Value) == "FERT")
            {
                ...
                try
                {
                    ...
                    DataTable dtTemp = helper.FillTable("14PP_StockPP_S2", CommandType.StoredProcedure
                    ...
                    // 리포트 미리보기 창에 레보프 북 등록 및 출력 장수 입력
