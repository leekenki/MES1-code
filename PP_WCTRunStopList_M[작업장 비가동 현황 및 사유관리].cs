    ...
    public partial class PP_WCTRunStopList_M : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("14PP_WCTRunStopList_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            #region 수정 
                            helper.ExecuteNoneQuery("14PP_WCTRunStopList_U1", CommandType.StoredProcedure
        ...
        {
            //그리드 컬럼간 머지 합병 기능 적용
            CustomMergedCellEvalutor CM1 = 
                new CustomMergedCellEvalutor("ORDERNO", "ITEMCODE");
